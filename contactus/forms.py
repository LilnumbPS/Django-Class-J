...
class UserRegisterForm(forms.Form):
    user_name=forms.CharField(max_length=300,widget=forms.TextInput(attrs={'placeholder':'please enter username'}))
    email=forms.EmailField(widget=forms.EmailInput(attrs={'placeholder':'please enter email'}))
    first_name=forms.CharField(max_length=50,widget=forms.TextInput(attrs={'placeholder':'please enter first name'}))
    ...
    password_2=forms.CharField(max_length=20,widget=forms.PasswordInput(attrs={'placeholder':'please enter password again'}))
    ...
    def clean_password_1(self):
        ...
        if password1!=password2:
            ...
            raise forms.ValidationError('باید پسوورد حداقل 8 کاراکتر باشد')
